...
/* harmony import */ var _modules_content_section__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/content-section */ "./js/modules/content-section.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  window.addEventListener('load', () => {
    ...
    contentElements.forEach(_modules_content_section__WEBPACK_IMPORTED_MODULE_3__["default"]);
    const accordeonElements = document.querySelectorAll('[data-accordeon]');
    accordeonElements.forEach(_modules_accordeon__WEBPACK_IMPORTED_MODULE_2__["default"]);
    document.querySelectorAll('form').forEach(_modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (accordeonElement => {
  ...
  accordeonElement.addEventListener('click', evt => {
    ...
    togglerElements.forEach(togglerElement => {
      const newExpandedValue = togglerElement === evt.target && expandedValue === 'false' ? 'true' : 'false';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/html */ "./js/utils/html.js");
...
const buttonTemplate = _utils_html__WEBPACK_IMPORTED_MODULE_0__["default"]`<button class="content-section__btn btn">
  ${ButtonText.CLOSED}
</button>`;
/* harmony default export */ __webpack_exports__["default"] = (sectionElement => {
  let isOpened = false;
  const innerElement = sectionElement.querySelector(INNER_SELECTOR);
  const bodyElement = innerElement.querySelector(BODY_SELECTOR);
  const contentParagraphElements = bodyElement.querySelectorAll(PARAGRAPHS_SELECTOR);
  if (contentParagraphElements.length > VISIBLE_PARAGRAPHS_COUNT) {
    ...
    buttonElement.addEventListener('click', () => {
      ...
      buttonElement.textContent = isOpened ? ButtonText.OPENED : ButtonText.CLOSED;
    });
  }
});
...
class Modals {
  ...
  _setSettings() {
    let settingKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._settingKey;
  ...
  _stopInteractive(modal) {
    if (this._stopPlay) {
      ...
      modal.querySelectorAll('[data-iframe]').forEach(el => {
        const options = '{"event": "command", "func": "pauseVideo", "args": ""}';
  ...
  open() {
    let modalName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._modalName;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function (raw) {
